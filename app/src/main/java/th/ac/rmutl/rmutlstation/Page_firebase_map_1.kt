...
class Page_firebase_map_1 : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.page_firebase_map_1)
        ...
        busesRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                children.forEach {
                    ...
                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(LatLng(18.811306, 98.954213), 15f))
                    val cameraPosition = CameraPosition.Builder()
                        .target(LatLng(18.811321, 98.954370))      // Sets the center of the map to location user
